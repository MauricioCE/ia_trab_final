...
MAX_RODADAS = 100
MAX_INTERACOES = 1000
MAX_INTERACOES_SEM_MELHORIA = 100
MAX_VIZINHOS = 20
PRECISAO_DECIMAL = 4


dados_q1 = [
    ("Q1", func_obj_1, [(-100.0, 100.0), (-100.0, 100.0)], "min", 0.5, 0.05),
    ("Q2", func_obj_2, [(-2.0, 4.0), (-2.0, 5.0)], "max", 0.15, 0.2),
    ("Q3", func_obj_3, [(-8.0, 8.0), (-8.0, 8.0)], "min", 0.005, 0.05),
    ("Q4", func_obj_4, [(-5.12, 5.12), (-5.12, 5.12)], "min", 0.001, 0.005),
    ("Q5", func_obj_5, [(-10.0, 10.0), (-10.0, 10.0)], "max", 0.1, 0.35),
    ("Q6", func_obj_6, [(-1.0, 3.0), (-1.0, 3.0)], "max", 0.02, 0.015),
]
